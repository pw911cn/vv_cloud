...
public class BeanUtils extends org.apache.commons.beanutils.BeanUtils {
	...
	/**
	 *<p>
	  * 名称:  getPropertyValue<BR>
	  * 描述:  功能说明: 通过域名取得bean的属性值<BR>
	  * 作者:  zhangguoxiao<BR>
	  * 日期:  2016年1月29日 下午5:16:35<BR>
	  * 
	  * @param bean
	  * @param fieldName
	  * @return  
	...
	{  
	    ...
	    Object obj = null;  
	    //update by zhangyang start  添加父类支持
	    Class cla = bean.getClass();
	    Class cl = cla.getSuperclass();
	    //update by zhangyang end
	    for (int i = 0; i < fields.length; i++) 
	    {  
	        Field field = fields[i];  
	    ...
	    if(cla!=null && cl!=Object.class){
	    	
		    Field[] superFields = cl.getDeclaredFields();
