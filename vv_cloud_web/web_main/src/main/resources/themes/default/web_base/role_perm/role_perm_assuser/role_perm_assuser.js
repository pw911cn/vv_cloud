define([ 'jquery', 'corectr','plugin/corejs/zTreeSearch/zTreeSearch'], function($, corectr,zTreeSearch) {
	...
	var _viewinit = function($thispage, renderdata) {
		...
		users_list={
			...
			ajax:function(fresh){
				...
				$.ajax({
					url:sys_config.base_serverpath+"/userrole/queryUserRole",
							...
							var settings={
								...
								callbacks:{
									del:function(data,wrap){
										...
										$.ajax({
											url:sys_config.base_serverpath+"/userrole/delUserRole",
		...
		data.param.menu_id=renderdata.menuId
		data.param.role_id=$("[name='role_id']").val();
		$.ajax({
			url:sys_config.base_serverpath+"/userrole/queryDeptUser",
				...
				var setting = {
						...
						callback : {
							...
							onClick : function(event, treeId, treeNode){
								...
								$.ajax({
									url:sys_config.base_serverpath+"/userrole/queryUserById",
									data:JSON.stringify(data),
									success:function(data){
	...
	var _eventbind = function($thispage, renderdata, opts) {
		  ...
		  $("#add_assuser",$thispage).on("click",function(){
			  ...
			  $.ajax({
					type :"post",					 
					url : sys_config.base_serverpath+"/userrole/addUserRole",
					data:JSON.stringify(data),
