define([ 'jquery', 'corectr'], function($, corectr) {
		...
		$("#menu_list_addBtn",$thispage).on('click',function() {
			corectr.v.popup({
                ...
                content:function($wrap, instance){ 
                	corectr.loadmodule({ 
                		module : "web_base/menu/menu_add/menu_add",
                		$todom : $wrap,
                		vpopup:instance
	...
	function menu_edit(flag,menu_id){
    	...
    	corectr.v.popup({
            ...
            content:function($wrap, instance){ 
            	corectr.loadmodule({ 
            		module : "web_base/menu/menu_edit/menu_edit",
            		$todom : $wrap,
            		vpopup:instance,
            		initdata_param:{
            			param:{
            		...
            		initdata_url:sys_config.base_serverpath+"/menu/getById",
	...
	function menu_toggle_freeze(flag,menu_id){
		var confirmIns =corectr.v.vConfirm({
			...
			confirmHandler: function () {
				  ...
				  if(flag==1){
					  toogleUrl=sys_config.base_serverpath+"/menu/freeze";
				  }else if(flag==2){
					  toogleUrl=sys_config.base_serverpath+"/menu/unfreeze";
				  }
    ...
    function tableInit($thispage,data) {
    	if(!table){
            ...
            table =corectr.v.table({
                ...
                ajax: {
                	url: sys_config.base_serverpath+"/menu/list",
