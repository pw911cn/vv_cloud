define([ 'jquery', 'corectr'], function($, corectr) {
	...
	function hos_edit(org_id){
    	corectr.v.popup({
            ...
            content:function($wrap, instance){ 
            	corectr.loadmodule({ 
            		module : "web_base/hos/hos_edit/hos_edit",
            		$todom : $wrap,
            		vpopup:instance,
            		initdata_param:{
            			param:{
            		...
            		initdata_url:sys_config.base_serverpath+"/base_org_hosp/getBaseOrgHospById",
	...
	function hos_toggle_freeze(flag,org_id){
		var confirmIns =corectr.v.vConfirm({
			...
			confirmHandler: function () {
				  ...
				  $.ajax({
						type :"post",					 
						url : sys_config.base_serverpath+"/base_org_hosp/del",
