...
/*		corectr.loadMoudle({
		...
		corectr.loadmodule({
			module : "web_main/home/home_sidebar",
			$todom : $("#home_sidebar_lyt", $thispage)
		});
		corectr.loadmodule({ 
    		module : "web_main/home/home_todo",
    		$todom : $("#home_todo_lyt", $thispage)
    	});
		corectr.loadmodule({ 
    		module : "web_main/home/mod/home_performance",
    		$todom : $("#home_performance_lyt", $thispage)
    	});
		corectr.loadmodule({ 
    		module : "web_main/home/mod/home_business",
    		$todom : $("#home_business_lyt", $thispage)
    	});
		corectr.loadmodule({ 
    		module : "web_main/home/mod/home_inform",
    		$todom : $("#home_inform_lyt", $thispage)
    	});
		corectr.loadmodule({ 
    		module : "web_main/home/mod/home_warning",
    		$todom : $("#home_warning_lyt", $thispage)
    	});
		corectr.loadmodule({ 
    		module : "web_main/home/mod/home_chart1",
    		$todom : $("#home_chart1_lyt", $thispage)
    	});
		corectr.loadmodule({ 
    		module : "web_main/home/mod/home_chart2",
        ...
        /*$('.tms4HomeIndex_setbtn').on('click',function () {
        	corectr.v.popup({
                ...
                width: 1000,
                height: 700,
                url: "web_main/sub_home/home_set.html",
