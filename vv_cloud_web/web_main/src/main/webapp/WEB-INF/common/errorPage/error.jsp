...
<body>
	<div class="TmsCom_errorK">
		<div class="TmsCom_error">
			<div class="TmsComl_error_cry"></div>
			<div class="TmsCom_error_numcode"><bbf:message key="page_errorPage_commonTips"/></div>
			<!-- <div class="TmsCom_error_numcode TmsCom_error_biao">未知错误！</div> -->
			<div class="TmsCom_error_text">${resultInfoVo.message}</div>
		</div>
	</div>
</body>
</html>