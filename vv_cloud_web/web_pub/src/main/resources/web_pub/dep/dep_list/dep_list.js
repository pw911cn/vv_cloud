define([ 'jquery', 'corectr'], function($, corectr) {
		...
		$("#dep_list_addBtn",$thispage).on('click',function() {
			corectr.v.popup({
                ...
                content:function($wrap, instance){ 
                	corectr.loadmodule({ 
                		module : "web_pub/dep/dep_add/dep_add",
                		$todom : $wrap,
                		vpopup:instance
	...
	function dep_edit(dept_id){
    	corectr.v.popup({
            ...
            content:function($wrap, instance){ 
            	corectr.loadmodule({ 
            		module : "web_pub/dep/dep_edit/dep_edit",
            		$todom : $wrap,
            		vpopup:instance,
            		initdata_param:{
            			param:{
            		...
            		initdata_url:server_zuulpath+"/base_dept/getBaseDeptById",
	...
	function dep_toggle_freeze(flag,dept_id){
		var confirmIns =corectr.v.vConfirm({
			...
			confirmHandler: function () {
				  ...
				  $.ajax({
						type :"post",					 
						url : server_zuulpath+"/base_dept/del",
